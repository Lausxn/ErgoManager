...
| Frontend | Angular 22, TypeScript 6, componentes standalone |
...
```
frontend/src/app/
├── core/        AuthService, guards de rol e interceptores HTTP
├── shared/      components/ reutilizables y models/ que reflejan los DTO
└── features/    auth, companies, users, forms, self-evaluation,
